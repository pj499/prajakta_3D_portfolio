    ...
    <Tilt className='xs:w-[250px] w-full'>
      <motion.div variants={fadeIn("right", "spring", index * 0.5, 0.75)} className='w-full green-pink-gradient p-[1px] rounded-[20px] shadow-card'>
        <div options={{max:45, scale:1, speed:400}} className='bg-tertiary rounded-[20px] py-5 px-12 min-h-[280px] flex justify-evenly items-center flex-col'>
          <img src={icon} loading="lazy" alt={title} className='w-16 h-16 object-contain'/>
    ...
    <>
      ...
      <div className="flex">
        <motion.p
          ...
          for clean code,  thoughtful design, and intelligent systems. With experience across full-stack development and AI-powered applications,
          ...
          learning even more?
          For me, building isn’t just about technology but it’s about creating solutions that feel intuitive and make life a little easier. I pick things up quickly, 
