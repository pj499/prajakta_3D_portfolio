...
const Hero = () => {
  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      <div
        className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5 -mt-8`}>
        ...
        <div>
          ...
          <p className={`${styles.heroSubText}  mt-1.5 text-white-100}`}>
